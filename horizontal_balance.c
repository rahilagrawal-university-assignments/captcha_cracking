...
//This is a C program to find the horizontal balance of a captcha image digit.
#include <stdio.h>
#include "captcha.h"
...
{	
	...
	//using the formula for calculating the horizontal balance of a digit
	//Formula given by lecturer in the lab exercises section
	horizontal_balance=(column_sum*1.0/n_black_pixels + 0.5)/width;
